...
def show_time_of_pid(line):
    pattern = r"^(\w*) ([0-9] [00-24]+:[00-59]+:[00-59]+) (\w+.\w+) CRON(\[(\d+)\]): USER \(\w*\)$"
...
print(
    show_time_of_pid("Jul 6 14:03:01 computer.name CRON[29440]: USER (naughty_user)")
...
print(
    show_time_of_pid("Jul 6 14:04:01 computer.name CRON[29440]: USER (naughty_user)")
)  # Jul 6 14:04:01 pid:29440

print(
    show_time_of_pid("Jul 6 14:05:01 computer.name CRON[29440]: USER (naughty_user)")
